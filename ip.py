...
class IP(ProcData):
    ...
    def __init__(self, data, upper):
        ...
        self._srcstr = str(data[12])+"."+str(data[13])+"."+str(data[14])+"."+str(data[15])
        self._dst = data[16:20]
        self._dststr = str(data[16]) + "." + str(data[17]) + "." + str(data[18]) + "." + str(data[19])
    ...
    def __str__(self):
        return (
                ...
                (
                    self.version, self._srcstr, self._dststr, self.head_len_byte, bin(self._service_set), self.total_len,
                    self.id,
